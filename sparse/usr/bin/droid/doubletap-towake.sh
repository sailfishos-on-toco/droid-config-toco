...
# to get here in the kernel https://github.com/sailfishos-on-toco/Xiaomi_Kernel_OpenSource/blob/toco-hybris-17.1/drivers/input/touchscreen/fts_521/fts.c#L6705
